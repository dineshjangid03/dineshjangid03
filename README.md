<p align="left">
  <img src="https://komarev.com/ghpvc/?username=dineshjangid03&label=Profile%20views&color=0e75b6&style=flat" alt="dineshjangid03" />
</p>

<img src="https://readme-typing-svg.herokuapp.com?font=Architects+Daughter&color=ff0000&size=22&lines=Hey!+I'm+Dinesh+Kumar+👋;Software+Engineer+%7C+Cybersecurity+Enthusiast;Dynamics+365+%7C+Azure+%7C+Full+Stack+Developer" style="width: 100%;">
...
- 💼 **Software Engineer at Alphavima Technology** (3+ years of industry experience)
- 🔐 **Cybersecurity-focused engineer** with strong auth, identity & cloud security background
- 🌐 Building **SaaS platforms** for Donor, Volunteer, Shop & School Management systems
- ⚙️ Daily work with **Microsoft Dynamics 365, Power Apps, Azure, .NET, Spring boot, Angular & Flutter**
- 🎓 Pursuing **MCA (Online)** — Vivekananda Global University (2024–2026)
...
- **Mobile:** Flutter
- **CRM & Low-Code:** Microsoft Dynamics 365, Power Apps, Power Apps Portal
- **Cloud & DevOps:** Azure Functions, Azure AD B2C, Azure Services
- **Databases:** SQL Server, MySQL
- **Security:** JWT, Azure B2C, .NET Identity & Spring Security
- **Integrations:** Razorpay, Stripe, Twilio (WhatsApp), Mailchimp, DocuSign
...
- Advanced **Cloud & Application Security**
...
- Secure authentication (JWT, Azure AD B2C)
- Azure Functions & cloud integrations
- Full-stack app architecture
- SaaS product design & security best practices

---

### ⚡ Fun Fact

> I still use **tabs over spaces** — and I’m not sorry 😄

---

### 📫 Reach Me At

- 📧 **Email:** dinesh.jangid323@gmail.com  
